...
| OpenAI / ChatGPT         | `@ai-sdk/openai`         | [Responses API web search](https://platform.openai.com/docs/guides/tools-web-search)                                    | Supports OpenAI API keys and ChatGPT Plus/Pro OAuth via `/connect`. If both are available, ChatGPT OAuth is preferred. Known unsupported: `gpt-4.1-nano`, and `gpt-5` with `reasoning.effort: "minimal"`. |
